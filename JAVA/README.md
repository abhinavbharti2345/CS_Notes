...
Welcome to the **Java Knowledge Base**. This module covers core Java concepts, object-oriented design, Collections Framework, concurrency, and rapid DSA syntax.

---

## ⚡ Quick Reference & Syntax
- [[Quick Look|⚡ Quick Look (Java DSA Cheatsheet & Forgotten Syntax)]] — Rapid reference for `Arrays.sort`, `Integer.MAX_VALUE`, `PriorityQueue`, `StringBuilder`, and common pitfalls.
