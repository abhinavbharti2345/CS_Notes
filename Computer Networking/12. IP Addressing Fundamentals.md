...
- **Prerequisites:**
  ...
  - [[11. MTU and Fragmentation|📏 MTU and IP Fragmentation]]
- **Next Logical Topics (Stage 3 — IP Addressing & Subnetting I):**
  - `[[13. Network ID and Host ID]]` — Splitting the 32 bits into the Network Prefix and Host identifier.
  - `[[14. Subnet Masks and CIDR Notation]]` — Classless Inter-Domain Routing (`/24`, `/26`, prefix lengths).
