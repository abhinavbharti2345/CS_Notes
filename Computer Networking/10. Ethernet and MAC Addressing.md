...
- **Next Logical Topics (Stage 2 & 3):**
  - [[11. MTU and Fragmentation|✂️ MTU and Fragmentation]] — Maximum Transmission Unit (1500-byte Ethernet limit) and IP fragmentation.
  - [[12. IP Addressing Fundamentals|🌐 IP Addressing Fundamentals]] — Deep dive into 32-bit IPv4 structure, classes, and subnetting.
