...
- **Prerequisites:**
  ...
  - [[09. Data Units - Segment, Packet, Frame, Bits|📊 Data Units - Segment, Packet, Frame, Bits]]
  - [[10. Ethernet and MAC Addressing|🪪 Ethernet and MAC Addressing]]
- **Next Logical Topics (Stage 3 — IP Addressing & Subnetting):**
  - [[12. IP Addressing Fundamentals|🌐 IP Addressing Fundamentals]] — Structure of 32-bit IPv4 addresses, dotted-decimal notation, and binary arithmetic.
  - [[13. Network ID and Host ID|🎯 Network ID and Host ID]] — Network prefix vs. host identifier.
  - [[14. Subnet Masks and CIDR Notation|🎭 Subnet Masks and CIDR Notation]] — Classless Inter-Domain Routing (`/24`, `/26`, prefix lengths).
