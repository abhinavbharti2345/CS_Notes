...
- **Next Logical Topics (Stage 2):**
  - `[[09. Data Units - Segment, Packet, Frame, Bits]]` — Deep dive into layer-specific PDUs.
  - `[[10. Ethernet and MAC Addressing]]` — 48-bit hex MAC formatting, NICs, and frame structures.
  - `[[11. MTU and Fragmentation]]` — Maximum Transmission Unit, IP fragmentation, and reassembly.
  - `[[12. IP Addressing Fundamentals]]` — How the destination and source addresses inside the IP header are structured.
