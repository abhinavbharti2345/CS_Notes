...
| **3. Network** | **Packet** (IP Datagram) | 20–60 bytes (IPv4) / 40 bytes (IPv6) | **IP Addresses** (e.g., `192.168.1.1`) | [[05. Network Hardware - Hub, Switch, Router, Modem|Routers]], Layer 3 Switches |
| **2. Data Link** | **Frame** | 14 bytes header + 4 bytes FCS | **MAC Addresses** (e.g., `AA:BB:CC:11:22:33`) | [[05. Network Hardware - Hub, Switch, Router, Modem|Switches]], Bridges, NICs |
| **1. Physical** | **Bits** | Preamble (8 bytes) | None (Raw physical signaling) | [[05. Network Hardware - Hub, Switch, Router, Modem|Hubs]], Modems, Repeaters |
...
- **Prerequisites:**
  - [[06. OSI vs TCP-IP Model|🧱 Layered Network Models (OSI vs TCP/IP)]]
  - [[07. Network Protocols and Standards|📜 Network Protocols and Standards]]
  - [[08. Encapsulation and Decapsulation|📦 Encapsulation and Decapsulation]]
- **Next Logical Topics (Stage 2):**
  - [[10. Ethernet and MAC Addressing|🏷️ Ethernet and MAC Addressing]] — 48-bit hex MAC formatting, NICs, and Ethernet frame structures.
  - [[11. MTU and Fragmentation|✂️ MTU and Fragmentation]] — Maximum Transmission Unit (1500 bytes), IP packet fragmentation, and reassembly.
  - [[12. IP Addressing Fundamentals|🌐 IP Addressing Fundamentals]] — Deep dive into 32-bit IPv4 structure and subnetting.
