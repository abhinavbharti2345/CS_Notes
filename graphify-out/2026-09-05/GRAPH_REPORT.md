# Graph Report - CS Notes  (2026-09-05)

## Corpus Check
- 47 files · ~24,667 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 498 nodes · 548 edges · 36 communities (32 shown, 3 thin omitted)
...
5. `JSON Canvas Skill` - 11 edges
6. `Introduction to Node.js` - 11 edges
7. `Embeds Reference` - 9 edges
8. `1. Single Number` - 9 edges
9. `2. Two Missing Numbers` - 9 edges
10. `3. Minimum XOR Pair` - 8 edges
...
Cohesion: 0.07
Nodes (30): Cards View, Common Formula Errors, Complete Examples, Daily Notes Index, Date Arithmetic, Default Summary Formulas, Duration Type, Embedding Bases (+22 more)
...
Cohesion: 0.10
Nodes (19): 🧭 Command Center, 🧠 Core Knowledge Graph, 🏗️ Learning Areas & Domains, ⚡ Quick Actions, 1. Core XOR Identities, 2. Cancellation & Algebraic Manipulation, 3. XOR Problem Recognition Guide, 4. Bit-Count XOR Observation (+11 more)

### Community 5 - "1. Single Number"
Cohesion: 0.07
Nodes (28): 1. Single Number, 3. Minimum XOR Pair, 4. Sum of XOR of All Pairs, 5. Complexity Summary Table, Algorithm, Algorithm, Algorithm, Approach (+20 more)

### Community 6 - "Functions Reference"
Cohesion: 0.13
...
Cohesion: 0.15
Nodes (13): 1. Even / Odd Check, 2. Left Shift (`<<`), 3. Right Shift (`>>`), 4. Bit Manipulation Operations, Bit Tricks, Check Bit (Is bit $i$ set?), Flip Bit (Toggle bit $i$), Navigation (+5 more)

### Community 10 - "Bit Manipulation"
Cohesion: 0.17
Nodes (12): 1. Introduction & Binary Representation, 2. Bit Positions & Indexing, 3. Section Overview, 4. ⚡ Quick Revision Cheat Sheet, Binary Representation (8-bit Example), Bit Formulas (Position $i$, 0-indexed from right), Bit Manipulation, Complexity Summary (+4 more)

### Community 11 - "4. Basic Properties"
Cohesion: 0.17
Nodes (12): 1. Overview, 2. Truth Table, 3. Class Worked Examples, 4. Basic Properties, AND Properties (`&`), Associative Property, Bitwise Operators, Commutative Property (+4 more)
...
### Community 16 - "Obsidian Vault Agent Instructions"
Cohesion: 0.33
...
### Community 28 - "🌐 Backend Development Knowledge Base"
Cohesion: 0.25
Nodes (8): 1. [[JavaScript Foundations|01. JavaScript Foundations]], 2. [[Node.js Runtime|02. Node.js Runtime & Architecture]], 3. Practical Lab Implementation, 🌐 Backend Development Knowledge Base, 📚 Core Modules, 🔄 Knowledge Flow Graph, 🗺️ Master 13-Part Learning Path, 🔗 Quick Links

### Community 29 - "🟨 JavaScript Foundations for Backend"
Cohesion: 0.33
...
### Community 31 - "🛒 ShopKart Authentication Project & Viva Prep"
Cohesion: 0.29
...
Cohesion: 0.17
Nodes (12): 1. Supervised Learning (Labels Provided), 2. Unsupervised Learning (No Labels Provided), A. Regression (Predicting a Continuous Number), B. Classification (Predicting a Discrete Category), Common Unsupervised Techniques:, Example: Customer Segmentation, Next Step, Prerequisites (+4 more)

### Community 34 - "Train-Test Split and Generalization"
Cohesion: 0.18
...
## Knowledge Gaps
- **351 isolated node(s):** `graphify`, `Purpose`, `1. Inspect Before Adding`, `2. Organize by Knowledge, Not Source`, `3. Universal CS Structure` (+346 more)
...
- **Why does `Variables and Data Types` connect `Variables and Data Types` to `Backend/README.md`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `Functions and Control Flow` connect `Functions and Control Flow` to `Backend/README.md`?**
