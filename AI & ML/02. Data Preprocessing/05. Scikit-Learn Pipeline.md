...
| :--- | :--- | :--- | :--- | :--- |
| **🏋️ Training** | `pipe.fit(X_train, y_train)` | **`fit()`** and **`transform()`** on `X_train` | Learns optimal parameters ($w, b$) | ✅ Safe |
...
- [[03. Missing Value Imputation]]
- [[02. Categorical Encoding]]
- [[Classical ML/Linear Regression Assumptions|📐 Linear Regression Assumptions]]
